...
getWarehouseCount() -> get numbers of warehouse       -> Desnecessário pq vc já tem sistema de compra de baú
setWarehouseCount(value) -> set numbers of warehouse  -> Desnecessário pq vc já tem sistema de compra de baú
...
###################################################################################################################################
getTradeTarget() -> get aIndex of the player target are in trade        -> Faria um script para evento automático 
setTradeTarget(value) -> set aIndex of the player target are in trade   -> Faria um script para evento automático

getExpRate() -> get experience rate                                                                  -> OK
setExpRate(value) -> set experience rate (you can use for add experience for a STAFF, SWORD etc...)  -> OK
